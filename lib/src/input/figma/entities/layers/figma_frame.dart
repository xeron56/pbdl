    ...
    for (var childNode in children!) {
      if (childNode is FigmaLine) {
        if (childNode.absoluteBoundingBox!.height! >
          ...
          absoluteBoundingBox!.width = absoluteBoundingBox!.width! + childNode.absoluteBoundingBox!.width!;
        } else {
          //absoluteBoundingBox!.height += childNode.absoluteBoundingBox!.height!;
          absoluteBoundingBox!.height = absoluteBoundingBox!.height! + childNode.absoluteBoundingBox!.height!;
        }
      }
    }
  }
