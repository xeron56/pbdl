...
PBDLStyle _$PBDLStyleFromJson(Map<String, dynamic> json) => PBDLStyle(
      fills: (json['fills'] as List<dynamic>?)
          ?.map((e) => PBDLFill.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      effects: (json['effects'] as List<dynamic>?)
          ?.map((e) => PBDLEffect.fromJson(e as Map<String, dynamic>))
          .toList(),
