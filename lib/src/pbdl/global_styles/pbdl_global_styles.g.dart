...
PBDLGlobalStyles _$PBDLGlobalStylesFromJson(Map<String, dynamic> json) =>
    PBDLGlobalStyles(
      colors: (json['colors'] as List<dynamic>?)
              ?.map((e) => PBDLGlobalColor.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      textStyles: (json['textStyles'] as List<dynamic>?)
              ...
              .toList() ??
          [],
      themeColors: (json['themeColors'] as List<dynamic>?)
              ?.map((e) => PBDLGlobalColor.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      themeTextStyles: (json['themeTextStyles'] as List<dynamic>?)
              ?.map((e) =>
                  PBDLGlobalTextStyle.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
